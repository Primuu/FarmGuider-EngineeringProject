...
import {BREEDING_PAGE_URL, COW_PAGE_URL, FIELD_BROWSER_PAGE_URL, FIELD_PAGE_URL, HOME_PAGE_URL, NOT_LOGGED_PAGE_URL, PROFILE_PAGE_URL} from "@/constants/ROUTER_URLS.ts";
