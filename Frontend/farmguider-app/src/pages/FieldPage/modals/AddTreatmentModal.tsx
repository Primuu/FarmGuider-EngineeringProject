...
import {createTreatment} from "@/services/treatmentService.ts";
...
const AddTreatmentModal: React.FC<AddTreatmentModalProps> = ({open, onClose, cropId, onTreatmentAdded}) => {
    ...
    const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
        ...
        if (cropId) {
            createTreatment(cropId, treatmentCreateDTO)
                .then(() => {
                    cancel();
                    onTreatmentAdded();
                    enqueueSnackbar(t('addTreatmentModal.successSnackbar'), SnackbarSuccess);
                })
                .catch(() => {
                ...
                <Box className="treatment-modal-box">
                    ...
                    >
                        <Box component="form" onSubmit={handleSubmit} className="treatment-form">
                            <Typography className="treatment-header">
                                {t('addTreatmentModal.header')}
                            </Typography>

                            <Typography className="treatment-sub-header">
                                {t('addTreatmentModal.subHeader')}
                            </Typography>
                            ...
                            <div className="treatment-form-container">
                                <TextField
                                    ...
                                    margin="normal"
                                    required
                                    label={t('addTreatmentModal.treatmentName')}
                                    type={"text"}
                                    value={treatmentName || ''}
                                ...
                                <div className="treatment-row-inputs">
                                    <div className="treatment-calendar">
                                        ...
                                        >
                                            <DatePicker
                                                label={t('addTreatmentModal.calendarLabel')}
                                                value={treatmentDate}
                                    ...
                                    <TextField
                                        ...
                                        required
                                        label={t('addTreatmentModal.quantity')}
                                        type="number"
                                        inputProps={{
                                            step: "0.01",
                                            min: "0.00",
                                ...
                                <TextField
                                    className="treatment-text-field"
                                    margin="normal"
                                    label={t('addTreatmentModal.details')}
                                    type={"text"}
                                    value={details || ''}
                            ...
                            <Typography className="treatment-req">
                                {t('addTreatmentModal.requirements')}
                            </Typography>
                            ...
                            <Box className="treatment-button-group">
                                ...
                                >
                                    ...
                                    {t('addTreatmentModal.confirmButton')}
                                </Button>
                                ...
                                >
                                    ...
                                    {t('addTreatmentModal.cancelButton')}
                                </Button>
                            </Box>
                        </Box>
                    </Slide>
